...
public class DeleteCustomerProfile : Profile
{
    ...
    {
        CreateMap<Guid, Application.Customers.DeleteCustomers.DeleteCustomerCommand>()
            .ConstructUsing(id => new Application.Customers.DeleteCustomers.DeleteCustomerCommand(id));
    }
}